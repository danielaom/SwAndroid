...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onStart() {
        super.onStart();
        textViewRegistro.setOnClickListener(new OnClickListener() {
            @Override
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Void> {
        ...
        UserLoginTask(String email, String password, Context paramContext) {
            mEmail = email;
            mPassword = password;
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                url = new URL(VariablesConstantes._URL_AUTENTIFICACION);
            ...
            try {
                ...
                Uri.Builder builder = new Uri.Builder()
                        .appendQueryParameter("usuario", mEmail).appendQueryParameter("password", mPassword);
